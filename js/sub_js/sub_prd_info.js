$(document).ready(function () {
  ...
  $(".choice_icon1 img").on("click", function () {
    ...
    // 이미지 소스를 변경
    if (img.attr("src") === "../../img/icon/web_icons/heart-empty_gr.svg") {
      img.attr("src", "../../img/icon/web_icons/heart-full-24px.svg");
    } else {
      img.attr("src", "../../img/icon/web_icons/heart-empty_gr.svg");
    }
  });
  //상세정보
  $.fn.extend({
